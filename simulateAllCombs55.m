function [] = simulateAllCombs55(identifier)
%like version 44, but we adapt the proposal distribution
...
tic
for k = 21:25
   permutationFileName = sprintf('sim%dBasic_Permutation%d.csv',identifier,k+95);
feval(fHandle, fileName, k+100, nSamples, logPriorGPMeans,logPriorGPSds, ...
    ...
    regInt,permutationFileName,true,NaN,burnIn,false,false,sparseGP)
end
toc
%move 2
