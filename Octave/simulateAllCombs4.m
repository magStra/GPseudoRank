function [] = simulateAllCombs4(identifier)
...
tic
for k = 1:5
 permutationFileName = sprintf('sim%dBasic_Permutation%d.csv',identifier,k+105);%105 instead of 100 to make it 
    %identical to simulation 5
...
tic
for k = 1:5
    permutationFileName = sprintf('sim%dBasic_Permutation%d.csv',identifier,k+105);
...
tic
for k = 1:5
    permutationFileName =sprintf('sim%dBasic_Permutation%d.csv',identifier,k+105);%105 instead of 100 to make it identical to simulation 5
