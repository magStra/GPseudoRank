function [ppath X dataProposedOrder] = ProposingPseudoRanksRegular(order,PP,data,moveProbs,nFeatures,...
    n0,n3,n3a)
%This function samples from the proposal distribution of the orders
%and returns the corresponding order and  pseudotimes for the pseudoRank
%function for the case of regularly space pseudotimes
